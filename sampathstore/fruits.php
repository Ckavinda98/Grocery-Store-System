...
<div class="container" >
 ...
 <div class="logo">
	...
	<li><a class="btn" style="border-radius: 30px;transition: background 0.5s;display: inline-block;padding: 8px 30px;marging: 30px 0;"> <i class="fa fa-user-circle"></i> Admin <?php echo $name;?></a> </li>
	<li><a class="btn" style="border-radius: 30px;transition: background 0.5s;display: inline-block;padding: 8px 30px;marging: 30px 0;" href="userLogout.php">Log Out &nbsp;<i class="fa fa-sign-out"></i></a>  </li> 
